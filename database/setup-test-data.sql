...
INSERT INTO Tenant (TenantId, TenantName, TenantEmail) VALUES (UNHEX(REPLACE(UUID(), '-', '')),'Test Tenant', 'test.tenant@gmail.com');
...
-- /* Kit Category */
-- INSERT INTO KitCategory (TenantId, CategoryName, CategoryDescription) VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Consumables', 'Regularly used items that need regularly replacing');
-- INSERT INTO KitCategory (TenantId, CategoryName, CategoryDescription) VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Activity Equipment', 'Items used for specific activities');
